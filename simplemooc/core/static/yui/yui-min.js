...
(function() {
 ...
 e.Get = i = {
  ...
  _getEnv: function() {
   ...
   return this._env = {
    ...
    cssLoad: (!n.gecko && !n.webkit || n.gecko >= 9 || n.compareVersions(n.webkit, 535.24) >= 0) && !
 ...
 YUI.Env._cssLoaded || (YUI.Env._cssLoaded = {}), e.Env.meta = g, e.Loader = function(t) {
  ...
  getRequires: function(t) {
   ...
   if (t.skinnable) {
    ...
    if (C && (C[c] || k && C[k])) {
     L = c, C[k] && (L = k);
     for (n = 0; n < C[L].length; n++) N = this._addSkin(C[L][n], c), this.isCSSLoaded(N, this
      ._boot) || y.push(N)
 ...
 }), YUI.Env[e.version].md5 = "fd7c67956df50e445f40d1668dd1dc80"
}, "3.12.0", {
 requires: ["loader-base"]
}), YUI.add("yui", function(e, t) {}, "3.12.0", {
 use: ["yui-base", "get", "features", "intl-base", "yui-log", "yui-later", "loader-base", "loader-rollup", "loader-yui3"]
});